...
export const DEFAULT_WINDOW_SHUTTER_COLOR = '#808080';
...
export const DEFAULT_MULLION_COLOR = '#FFFFFF';
...
export const DEFAULT_DOOR_FRAME_COLOR = '#FFFFFF';
...
export const DEFAULT_ROOF_SIDE_COLOR = '#ffffff';
