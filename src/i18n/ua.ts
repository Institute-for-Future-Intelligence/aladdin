...
export const i18n_ua = {
  translation: {
    ...
    optimizationMenu: {
      ...
      Objective: 'Ціль',
      ObjectiveFunctionDailyTotalOutput: 'Щоденний загальний дохід',
      ObjectiveFunctionYearlyTotalOutput: 'Щорічний загальний дохід',
      ObjectiveFunctionDailyAverageOutput: 'Щоденний середній дохід',
      ObjectiveFunctionYearlyAverageOutput: 'Щорічний середній дохід',
    ...
    projectPanel: {
      ...
      SelectPropertyToSort: 'Select property to sort',
