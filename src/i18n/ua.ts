...
export const i18n_ua = {
  translation: {
    ...
    cookie: {
      Statement:
        'Натиснувши «Прийняти», ви погоджуєтеся з використанням файлів cookie для покращення вашого досвіду з Аладдіном.',
      Accept: 'Прийняти',
    },

    aboutUs: {
      ProductBroughtToYouBy: 'Цей Продукт Створений',
      ...
      FundingInformation:
        'Національний Науковий Фонд (ННФ) надав фінансову підтримку для дослідження та розробки цього продукту за допомогою грантів №2105695 та №2131097. Однак, будь-які погляди, результати та висновки, висловлені у цьому продукті, належать авторам і можуть не повністю відображати погляди ННФ.',
      Contact: 'Для отримання додаткової інформації, зверніться до Charles Xie (charles@intofuture.org).',
    ...
    word: {
      ...
      BuildingHVACSystem: 'Система Опалення, Вентиляції та Кондиціонування Приміщень',
