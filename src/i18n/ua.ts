...
export const i18n_ua = {
  translation: {
    ...
    cookie: {
      Statement: 'Натиснувши «Прийняти», ви погоджуєтеся з використанням файлів cookie для покращення вашого досвіду з Aladdin.',
      Accept: 'Прийняти',
    },
    ...
    word: {
      ...
      BuildingHVACSystem: 'Побудова Системи Опалення, Вентиляції та Кондиціонування Приміщення',
    ...
    menu: {
      ...
      cloudMenu: 'Хмарне меню',
      fileSubMenu: 'Файл',
      file: {
        CreateNewFile: 'Створити новий файл',
        OpenLocalFile: 'Відкрити локальний файл',
        SaveAsLocalFile: 'Зберегти як локальний файл',
        SavingAbortedMustHaveValidFileName: "Збереження перервано! Вам потрібно мати дійсне ім'я файлу",
        OpenCloudFile: 'Відкрити файл у хмарі',
        SaveCloudFile: 'Зберегти файл у хмарі',
        SaveAsCloudFile: 'Зберегти як файл у хмарі',
      ...
      solarUpdraftTower: {
          AnalyzeDailyYield: 'Аналізувати щоденний вихід',
          AnalyzeYearlyYield: 'Аналізувати щорічний вихід',
          SolarUpdraftTowerSimulationNoAnimation: 'Немає анімації для симуляції сонячної вежі з відпрацьовуваним повітрям',
      },      
      ...
      solarEnergyExamples: {
          ...
          RainbowSwashSolarFarmBostonMA: 'Сонячна ферма Rainbow Swash в Бостоні, МА',
          MickeyMouseSolarFarmOrlandoFL: 'Сонячна ферма Міккі Мауса в Орландо, ФЛ',
          SolarPanelsOverCanalBakersfieldCA: 'Сонячні панелі над каналом в Бейкерсфілді, КА',
          SolarNoiseBarrierLexingtonMA: "Сонячний шумовий бар'єр в Лексінгтоні, МА",
