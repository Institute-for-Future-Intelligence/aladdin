...
export const i18n_zh_tw = {
  translation: {
    ...
    foundationMenu: {
      ...
      RemoveAllHumans: '刪除此地基上所有的人物',
      RemoveAllTrees: '刪除此地基上所有的樹木',
      Racks: '支架',
      Texture01: '一號材質',
      Texture02: '二號材質',
      Texture03: '三號材質',
      ...
      Humans: '人物',
      DoYouReallyWantToRemoveAllHumansOnFoundation: '你確定刪除此地基上所有的人物嗎',
      Trees: '樹木',
      DoYouReallyWantToRemoveAllTreesOnFoundation: '你確定刪除此地基上所有的樹木嗎',
    ...
    cuboidMenu: {
      ...
      RemoveAllHumans: '刪除此長方體表面上所有的人物',
      RemoveAllTrees: '刪除此長方體表面上所有的樹木',
      Racks: '支架',
      SolarPanels: '光伏板',
      ...
      Humans: '人物',
      DoYouReallyWantToRemoveAllHumansOnCuboid: '你確定刪除此長方體表面上所有的人物嗎',
      Trees: '樹木',
      DoYouReallyWantToRemoveAllTreesOnCuboid: '你確定刪除此長方體表面上所有的樹木嗎',
