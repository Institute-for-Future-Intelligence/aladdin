...
export const i18n_zh_tw = {
  translation: {
    ...
    message: {
      CopiedAndReadyToPaste: '現在可以粘貼了。',
      ListenToPodcastAboutThis: '聽聽播客',
      LabelIsAlreadyTaken: '此標籤已被占用，請更換。',
    ...
    menu: {
      ...
      storage: {
        AnalyzeDailyChargeDischarge: '分析當天充放電曲線',
        AnalyzeYearlyStorage: '分析全年儲存能量',
      },
      ...
      photovoltaicSolarPowerTutorials: {
        ...
        SolarPanelArrayOnSlope: '斜坡上的光伏板陣列',
      },
      ...
      concentratedSolarPowerTutorials: {
        ...
        BuildingIntegratedFresnelReflectors: '建築整合的菲涅耳反射鏡',
      ...
      generativeDesignTutorials: {
        ...
        GenerativeOptimizationEnergyEfficientHouse: '節能房屋的生成式最佳化設計',
      },
    ...
    protractorMenu: {
      OnlyThisProtractor: '只這個量角器',
      AllSelectedProtractors: '所有選中的量角器',
    ...
    batteryStorageMenu: {
      ...
      DischargingEfficiency: '放電效率',
      HvacIdSelection: '暖通空調系統',
    ...
    editorPanel: {
      EditorParameters: '編輯器參數',
      ArrowKeyMoveStep: '箭頭鍵移動步長',
    },
    ...
    solutionSpace: {
      ...
      Solar: '光伏',
      Net: '净能耗',
      HeliostatLength: '定日鏡長度',
      HeliostatWidth: '定日鏡寬度',
      heliostatCount: '定日鏡數量',
      TowerHeight: '吸熱塔高度',
      PackingDensity: '佈置密度',
