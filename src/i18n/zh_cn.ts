...
export const i18n_zh_cn = {
  translation: {
    ...
    message: {
      ...
      GeneratingUrbanDesign: '正在生成城市设计...',
      ...
      GeneratingUrbanDesignMayTakeAWhile:
        '生成一个城市设计可能需要一些时间且无法取消。在按确定键前请仔细考虑好给AI的输入。',
      GeneratedResultNotAccepted: '抱歉，返回结果无法解读。',
      NumberOfDesignsInProjectExceeds: '此项目的设计数目超过',
      RemoveSomeDesignsFromProjectToContinue: '如要继续请从此项目里删除一些设计',
    },
    ...
    menu: {
      ...
      buildingScienceTutorials: {
        ...
        EffectOfAirtightnessOnBuildingEnergy: '房屋气密性对能耗的影响',
      ...
      otherTypesOfSolarPowerTutorials: {
        SolarWaterHeaters: '太阳能热水器',
        SolarUpdraftTower: '太阳能上升气流塔',
      },

      windPowerSubMenu: '风力发电',
      windPowerTutorials: {
        EffectOfBladeNumberOfWindTurbine: '转子叶片的数目对风力涡轮机输出的影响',
        EffectOfPitchAngleOfWindTurbineBlades: '转子叶片的俯仰角对风力涡轮机输出的影响',
        BirdSafeBladeDesign: '对鸟类安全的叶片设计',
        OffshoreWindFarm: '海上风电场',
      },

      storageSubMenu: '能量储存',
      storageTutorials: {
        HomeSolarEnergyStorage: '家用太阳能储能系统',
      },
      ...
      solarEnergyExamples: {
        ...
        CompareGenerationConsumption: '对比发电量和耗电量',
    ...
    HVACMenu: {
      ...
      ACCoefficientOfPerformance: '空调性能系数',
    ...
    groundMenu: {
      ...
      MonthlyIrradianceLossExplanation: '由于污垢和积雪等因素，到达表面的太阳辐射减少的程度。',
      Vegetation: '植被',
      LeafOutDay: '树叶长出的日子',
      LeafOffDay: '树叶脱落的日子',
      Albedo: '反照率',
    ...
    cuboidMenu: {
      ...
      RemoveAllUnlockedLights: '删除此长方体表面上所有非固定的电灯',
      Racks: '支架',
      SolarPanels: '光伏板',
      Lights: '电灯',
      DoYouReallyWantToRemoveAllLightsOnCuboid: '你确定删除此长方体表面上所有非固定的电灯吗',
    ...
    pvModelPanel: {
      ...
      General: '概况',
      Electrical: '电气',
      CellCountInXDirection: 'X方向电池数目',
      CellCountInYDirection: 'Y方向电池数目',
      Weight: '重量',
      Kilogram: '千克',
      RatedVoltage: '额定电压',
      RatedCurrent: '额定电流',
      ...
      ThinFilm: '薄膜',
      Bifacial: '双面',
      PowerBifaciality: '功率双面性因子（背面对正面）',
      Black: '黑色',
      Blue: '蓝色',
      ...
      DisplayThisCustomSolarPanel: '展示这个定制光伏板',
      ExportThisCustomSolarPanel: '输出此定制光伏板',
      ImportCustomSolarPanelFromClipboard: '从系统剪切板输入定制光伏板数据',
      CustomSolarPanelExportedToClipboard: '定制光伏板拷贝到剪贴板',
      DoYouReallyWantToRemoveThisCustomSolarPanel: '你确定删除此定制光伏板',
      MakeSureThisCustomSolarPanelIsNotUsed: '删除之前请确认此定制光伏板没有被当前文件采用',
      ThisCustomSolarPanelIsUsed: '此定制光伏板被当前文件采用',
      DoYouReallyWantToImportCustomSolarPanel: '你确定輸入定制光伏板',
    ...
    windTurbineMenu: {
      ...
      RotorBladePitchAngle: '转子叶片俯仰角',
      RelativeYawAngle: '相对偏流角',
    ...
    wallMenu: {
      ...
      Doors: '门',
      LockAllUnlockedDoors: '固定所有非固定的门',
      UnlockAllLockedDoors: '解除所有的门固定',
      ...
      Lights: '电灯',
      LockAllUnlockedLights: '固定这堵墙上所有非固定的电灯',
      UnlockAllLockedLights: '解除这堵墙上所有的电灯固定',
      ...
      DoYouReallyWantToRemoveAllPolygonsOnThisWall: '你确定删除这堵墙上所有非固定的多边形吗',
      WallStructure: '墙结构',
      DefaultStructure: '默认',
      StudStructure: '墙柱',
      PillarStructure: '圆柱',
    ...
    solarPanelYieldPanel: {
      CompareWithElectricityConsumption: '对比耗电量',
    ...
    projectPanel: {
      ...
      SolutionSpaceScreenshot: '设计空间截屏',
      ScatterPlotScreenshot: '散点图截屏',
    ...
    shadowSettingsPanel: {
      ShadowSettings: '阴影设定',
      ShadowCameraFarDistance: '最远距离',
      ShadowMapSize: '映射图长宽',
      Notes: '注意事项',
      RefreshPageNote: '改变设置后须刷新页面。',
      MapSizeWarning: '大的映射图长宽可能导致阿拉丁无法在某些电脑上运行。',
    },
    ...
    analysisManager: {
      ...
      NoBatteryStorageForAnalysis: '没有已连接的蓄电池可以分析',
    },
    ...
    toolbar: {
      ...
      AddHeliostat: '添加定日镜',
      AddWindTurbine: '添加水平轴风力涡轮机',
      AddVerticalAxisWindTurbine: '添加垂直轴风力涡轮机',
      AddLight: '添加电灯',
      AddTree: '添加树木',
      AddFlower: '添加花草',
      AddPeople: '添加人物',
    ...
    modelsMap: {
      ...
      TotalNumberOfUserPublishedModelsInSelectedPeriod: '选定时间段用户发布的模型总数',
      AllTimeTotal: '全部时间用户发布的模型总数',
