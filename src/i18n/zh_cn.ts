...
export const i18n_zh_cn = {
  translation: {
    ...
    optimizationMenu: {
      ...
      ObjectiveFunctionYearlyOutput: '全年产出',
      GeneticAlgorithmSelectionMethod: '基因算法选择方法',
      RouletteWheel: '轮盘',
      Tournament: '淘汰制',
    ...
    toolbar: {
      ...
      AddGableRoof: '添加人字形屋顶',
      AddHipRoof: 'Add HipRoof',
      AddGambrelRoof: 'Add GambrelRoof',
      AddCuboid: '添加长方体',
      AddSensor: '添加传感器',
      AddSolarPanel: '添加光伏板',
      ...
      SwitchToAddingGableRoof: '切换到添加人字形屋顶模式',
      SwitchToAddingHipRoof: 'Switch to Adding HipRoof',
      SwitchToAddingGambrelRoof: 'Switch to Adding GambrelRoof',
