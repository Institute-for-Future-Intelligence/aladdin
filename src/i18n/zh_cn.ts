  ...
  translation: {
    ...
    menu: {
      ...
      tutorials: {
        ...
        EffectOfReceiverPipeHeightForLinearFresnelReflectors: '吸热长管的安装高度对直线式菲涅尔反射镜发电量的影响',
    ...
    foundationMenu: {
      ...
      ReceiverPipeForFresnelReflectors: '和菲涅尔反射镜配套的吸热长管',
      ReceiverTowerForHeliostats: '和定日镜配套的吸热高塔',
      SolarReceiverPhysicalProperties: '太阳能吸收器的物理性质',
      SolarReceiverHeight: '太阳能吸收器的安装高度',
      SolarReceiverApertureWidth: '太阳能吸收器的孔径',
      SolarReceiverPipePoleNumber: '太阳能吸收器的支柱数量',
    ...
    fresnelReflectorMenu: {
      Receiver: '吸收管',
      SelectReceiverToReflectSunlightTo: '选择阳光反射到的吸收管',
      ModuleLength: '模块长度',
      Modules: '模块',
      ModulesLong: '模块长',
