  ...
  translation: {
    ...
    menu: {
      ...
      examples: {
        ...
        SolarFarm: '太阳能农场',
        NevadaSolarOneParabolicTroughArray: '内华达太阳能一号的抛物线槽阵列',
        TooeleParabolicDishArray: '犹他图埃勒抛物线碟阵列',
        PS10SolarPowerTower: 'PS10太阳能发电塔',
        ...
        FixedSolarPanelArraysInRealWorld: '一个真实世界里的固定角度光伏板阵列',
        HSATSolarTrackersInRealWorld: '一个真实世界里的水平方向单轴旋转追日光伏板阵列（HSAT）',
