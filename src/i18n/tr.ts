...
export const i18n_tr = {
  translation: {
    ...
    groundMenu: {
      ...
      RemoveAllTrees: 'Tüm Aðaçlarý Kaldýr',
      RemoveAllPeople: 'Tüm Ýnsanlarý Kaldýr',
      RemoveAllFoundations: 'Tüm Temelleri Kaldýr',
      RemoveAllCuboids: 'Tüm Küboidleri Kaldýr',
      DoYouReallyWantToRemoveAllPeople: 'Gerçekten tüm insanlarý kaldýrmak istiyor musunuz?',
      DoYouReallyWantToRemoveAllTrees: 'Gerçekten tüm aðaçlarý kaldýrmak istiyor musunuz?',
      DoYouReallyWantToRemoveAllFoundations: 'Gerçekten tüm temelleri kaldýrmak istiyor musunuz?',
      DoYouReallyWantToRemoveAllCuboids: 'Gerçekten tüm küboidleri kaldýrmak istiyor musunuz?',
    },

    foundationMenu: {
      RemoveAllSolarPanels: 'Tüm Güneþ Panellerini Kaldýr',
      RemoveAllSensors: 'Tüm Sensörleri Kaldýr',
      RemoveAllWalls: 'Tüm Duvarlarý Kaldýr',
      RemoveAllPolygons: 'Tüm Poligonlarý Kaldýr',
      ...
      DoYouReallyWantToRemoveAllSolarPanelsOnFoundation:
        'Bu temel üzerindeki tüm güneþ panellerini gerçekten kaldýrmak istiyor musunuz?',
      Sensors: 'Sensörler',
      DoYouReallyWantToRemoveAllSensorsOnFoundation:
        'Bu temel üzerindeki tüm sensörleri gerçekten kaldýrmak istiyor musunuz?',
      Walls: 'Duvarlar',
      DoYouReallyWantToRemoveAllWallsOnFoundation:
        'Bu temel üzerindeki tüm duvarlarý gerçekten kaldýrmak istiyor musunuz?',
      Polygons: 'Poligonlar',
      DoYouReallyWantToRemoveAllPolygonsOnFoundation:
        'Bu temel üzerindeki tüm poligonlarý gerçekten kaldýrmak istiyor musunuz?',
      Humans: 'Humans',
    ...
    cuboidMenu: {
      ...
      Texture09: 'Tekstür 9',
      Texture10: 'Tekstür 10',
      RemoveAllSolarPanels: 'Tüm Güneþ Panellerini Kaldýrýn',
      RemoveAllSensors: 'Tüm Sensörleri Kaldýr',
      RemoveAllPolygons: 'Tüm Poligonlarý Kaldýr',
      RemoveAllHumans: 'Remove All Humans',
      RemoveAllTrees: 'Remove All Trees',
      ...
      DoYouReallyWantToRemoveAllSolarPanelsOnCuboid:
        'Bu küboid üzerindeki tüm güneþ panellerini gerçekten kaldýrmak istiyor musunuz?',
      Sensors: 'Sensörler',
      DoYouReallyWantToRemoveAllSensorsOnCuboid:
        'Bu küboid üzerindeki tüm sensörleri gerçekten kaldýrmak istiyor musunuz?',
      Polygons: 'Poligonlar',
      DoYouReallyWantToRemoveAllPolygonsOnCuboid:
        'Bu küboid üzerindeki tüm çokgenleri gerçekten kaldýrmak istiyor musunuz?',
      Humans: 'Humans',
