...
interface FountaionDialogItems {
  Dialog: (props: { setDialogVisible: (b: boolean) => void }) => JSX.Element;
  children?: React.ReactNode;
}

export const GroupMasterCheckbox = ({ foundation }: FoundationItemProps) => {
  ...
  return (
    <MenuItem stayAfterClick>
      <Checkbox checked={foundation.enableGroupMaster} onChange={onChange}>
...
export const ShowLabelCheckbox = ({ foundation }: FoundationItemProps) => {
...
export const LabelTextInput = ({ foundation }: FoundationItemProps) => {
...
export const LabelHeightInput = ({ foundation }: FoundationItemProps) => {
...
export const LabelFontSizeInput = ({ foundation }: FoundationItemProps) => {
...
export const LabelSizeInput = ({ foundation }: FoundationItemProps) => {
...
export const LabelColorInput = ({ foundation }: FoundationItemProps) => {
...
export const DialogItem = ({ Dialog, children }: FountaionDialogItems) => {
