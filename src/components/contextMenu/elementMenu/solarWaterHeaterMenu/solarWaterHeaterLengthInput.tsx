...
const SolarWaterHeaterLengthInput = ({ setDialogVisible }: { setDialogVisible: (b: boolean) => void }) => {
  ...
  const withinParent = (sp: SolarWaterHeaterModel, lx: number) => {
  ...
  const rejectChange = (sp: SolarWaterHeaterModel, lx: number) => {
...
export default SolarWaterHeaterLengthInput;
