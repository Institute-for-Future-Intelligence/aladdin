...
const ParabolicTroughOpticalEfficiencyInput = ({
  dialogVisible,
  setDialogVisible,
}: {
  ...
  const updateById = useStore(Selector.updateCspOpticalEfficiencyById);
  const updateAboveFoundation = useStore(Selector.updateCspOpticalEfficiencyAboveFoundation);
  const updateForAll = useStore(Selector.updateCspOpticalEfficiencyForAll);
  ...
  const setOpticalEfficiency = (value: number) => {
    ...
    switch (actionScope) {
      ...
      default:
        if (parabolicTrough) {
          const oldOpticalEfficiency = parabolicTrough.opticalEfficiency;
