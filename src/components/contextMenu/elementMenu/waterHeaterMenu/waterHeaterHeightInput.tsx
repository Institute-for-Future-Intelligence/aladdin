...
const WaterHeaterHeightInput = ({ setDialogVisible }: { setDialogVisible: (b: boolean) => void }) => {
  ...
  const withinParent = (sp: WaterHeaterModel, lz: number) => {
  ...
  const rejectChange = (sp: WaterHeaterModel, lz: number) => {
...
export default WaterHeaterHeightInput;
