...
import {
  ...
  DEFAULT_BATTERY_STORAGE_EFFICIENCY,
  DEFAULT_BATTERY_STORAGE_COLOR,
...
export class ElementModelFactory {
  ...
  static makeBatteryStorage(parent: ElementModel, x: number, y: number, z: number) {
    return {
      ...
      ly: 2,
      lz: 1.5,
      chargingEfficiency: DEFAULT_BATTERY_STORAGE_EFFICIENCY,
      dischargingEfficiency: DEFAULT_BATTERY_STORAGE_EFFICIENCY,
      normal: [0, 0, 0],
      rotation: [0, 0, 0],
      color: DEFAULT_BATTERY_STORAGE_COLOR,
  ...
  static makeFoundation(x: number, y: number, height: number, color: string, texture: FoundationTexture) {
    ...
    return {
      ...
      rotation: [0, 0, 0],
      parentId: GROUND_ID,
      color: color ?? DEFAULT_FOUNDATION_COLOR,
  ...
  static makeWall(parent: ElementModel, x: number, y: number, z?: number, normal?: Vector3) {
    const actionState = useStore.getState().actionState;
    const lz = actionState.wallHeight ?? DEFAULT_WALL_HEIGHT;
    return {
      ...
      eavesLength: actionState.wallEavesLength ?? DEFAULT_WALL_EAVES_LENGTH,
      rValue: actionState.wallRValue ?? DEFAULT_WALL_R_VALUE,
      fill: WallFill.Full,
      leftUnfilledHeight: DEFAULT_WALL_UNFILLED_HEIGHT,
      rightUnfilledHeight: DEFAULT_WALL_UNFILLED_HEIGHT,
      leftTopPartialHeight: lz - DEFAULT_WALL_UNFILLED_HEIGHT,
      rightTopPartialHeight: lz - DEFAULT_WALL_UNFILLED_HEIGHT,
      relativeAngle: 0,
      leftPoint: [],
      rightPoint: [],
      leftJoints: [],
      ...
      color: actionState.wallColor ?? DEFAULT_WALL_COLOR,
      ...
      structureSpacing: actionState.wallStructureSpacing ?? DEFAULT_WALL_STRUCTURE_SPACING,
      structureWidth: actionState.wallStructureWidth ?? DEFAULT_WALL_STRUCTURE_WIDTH,
      structureColor: actionState.wallStructureColor ?? DEFAULT_WALL_STRUCTURE_COLOR,
      opacity: actionState.wallOpacity !== undefined ? actionState.wallOpacity : DEFAULT_WALL_OPACITY,
      showLabel: false,
      normal: normal ? normal.toArray() : [0, 0, 1],
      rotation: [0, 0, 0],
      parentId: parent.id,
  ...
  static makeWindow(
    ...
    return {
      ...
      shutterColor: actionState.windowShutterColor ?? DEFAULT_WINDOW_SHUTTER_COLOR,
      ...
      lineColor: '#000000',
      showLabel: false,
      color: actionState.windowColor ?? DEFAULT_WINDOW_COLOR, // frame color
      tint: actionState.windowTint ?? DEFAULT_WINDOW_TINT, // glass color
      opacity: actionState.windowOpacity !== undefined ? actionState.windowOpacity : DEFAULT_WINDOW_OPACITY,
