...
const DailyParabolicTroughYieldPanel = React.memo(({ city }: DailyParabolicTroughYieldPanelProps) => {
  ...
  return (
    ...
    >
      <Container
        ref={nodeRef}
        style={{ zIndex: selectedFloatingWindow === 'dailyParabolicTroughYieldPanel' ? Z_INDEX_FRONT_PANEL : 9 }}
      >
        <ColumnWrapper
          ref={wrapperRef}
          style={{
...
export default DailyParabolicTroughYieldPanel;
